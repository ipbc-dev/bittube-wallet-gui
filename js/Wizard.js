...
function walletPathExists(directory, filename, isIOS, walletManager) {
    ...
    if(isIOS)
        var path = bittubeAccountsDir + filename;
    else
...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of bittube birth 2014-04-18 10:49:53 (1397818193)
    var bittubeBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    if (requestedTime > bittubeBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - bittubeBirthTime)/secondsPerBlockV1);
